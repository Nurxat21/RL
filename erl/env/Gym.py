...
def build_env(env, if_print=False, env_num=1, device_id=None, args=None, ):
    ...
    if env_name in {'LunarLander-v2', 'LunarLanderContinuous-v2',
        ...
        from env.CarRacingFix import CarRacingFix
        env = CarRacingFix()
    ...
    if env_name.find('Isaac') >= 0:
        from env.IsaacGym import PreprocessIsaacOneEnv, PreprocessIsaacVecEnv
    ...
    if env_name[:10] in {'StockDOW5', 'StockDOW30', 'StockNAS74', 'StockNAS89'}:
        ...
        gamma = 0.993
        from env.FinRL.StockTradingEnv import StockEnvDOW5, StockEnvDOW30, StockEnvNAS74, StockEnvNAS89
    ...
    if env_name in {'DownLinkEnv-v0', 'DownLinkEnv-v1', 'DownLinkEnv-v2'}:
        from env.DownLink import DownLinkEnv0, DownLinkEnv1, DownLinkEnv2
