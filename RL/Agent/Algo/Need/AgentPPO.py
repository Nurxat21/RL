import torch
import numpy as np
from RL.Agent.Algo.Need.Base.AgentBase import AgentBase
from RL.Agent.Algo.Need.Base.net import ActorPPO, ActorDiscretePPO, CriticPPO, SharePPO
...
class AgentPPO(AgentBase):
    ...
    def explore_vec_env(self, env, target_step):
        ...
        for step_i in range(target_step):
            ten_actions, ten_noises = self.select_actions(ten_states)
            tem_next_states, ten_rewards, ten_dones = env.step(ten_actions.tanh())  # Action Function
